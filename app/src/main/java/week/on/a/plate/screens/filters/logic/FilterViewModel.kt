...
import week.on.a.plate.screens.filters.logic.crud.ingredient.IngredientCRUD
import week.on.a.plate.screens.filters.logic.crud.ingredientCategory.IngredientCategoryCRUD
import week.on.a.plate.screens.filters.logic.crud.tag.TagCRUD
import week.on.a.plate.screens.filters.logic.crud.tagCategory.TagCategoryCRUD
        ...
        when (event) {
            ...
            is FilterEvent.EditOrDeleteTagCategory -> {
                ...
                editOrDelete(
                    delete = {
                        viewModelScope.launch {
                            tagCategoryCRUD.deleteTagCategory(
                                event.tagCategory
                            )
                        }
                    },
