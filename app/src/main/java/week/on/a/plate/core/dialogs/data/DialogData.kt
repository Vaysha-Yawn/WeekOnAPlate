package week.on.a.plate.core.dialogs.data
...
sealed class DialogData(val onEvent: (MainEvent) -> Unit) {
    ...
    class EditIngredient @OptIn(ExperimentalMaterial3Api::class) constructor(
        ...
        val done = {
            onEvent(MainEvent.ActionDBMenu(ActionWeekMenuDB.EditIngredientDB(this)))
            close()
        }
    ...
    class AddIngredientPosition @OptIn(ExperimentalMaterial3Api::class) constructor(
        ...
        val done = {
            onEvent(MainEvent.ActionDBMenu(ActionWeekMenuDB.AddIngredientDB(this)))
            close()
        }
