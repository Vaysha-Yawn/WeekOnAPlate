...
@Composable
fun SourceRecipeEdit(state: RecipeCreateUIState) {
    Column(Modifier.padding(horizontal =  24.dp)) {
        TextBody(text = stringResource(R.string.source_title))
        Spacer(modifier = Modifier.height(12.dp))
        EditTextLine(text = state.link, placeholder = stringResource(R.string.enter_recipe_link)) {
...
@Composable
fun TabCreateRecipe(state: RecipeCreateUIState) {
