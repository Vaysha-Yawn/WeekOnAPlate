...
fun BlockCalendar(
    ...
    Row(
        ...
        Icon(painterResource(R.drawable.back), "Last week", modifier = Modifier.clickable {
            chooseLastWeek()
        }.size(36.dp))
        ...
        Icon(painterResource(R.drawable.forward), "Next week", modifier = Modifier.clickable {
            chooseNextWeek()
        }.size(36.dp))
    }
}