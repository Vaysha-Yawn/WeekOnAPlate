...
import week.on.a.plate.core.uitools.buttons.PlusButton
import week.on.a.plate.core.uitools.buttons.PlusButtonSmall
...
fun TitleMenu(name:String, actionAdd:()->Unit){
    Row(Modifier.padding(horizontal = 10.dp), verticalAlignment = Alignment.CenterVertically) {
        TextInApp(text = name, textStyle = Typography.bodyLarge, modifier = Modifier.padding(end = 20.dp))
        PlusButton(actionAdd)
    }
}
