...
sealed class MenuEvent : Event() {
    ...
    data class EditPositionMore(val position: Position, val context:Context) : MenuEvent()
    data class EditOtherPosition(val position: Position, val context: Context) : MenuEvent()
    ...
    data class EditOrDeleteSelection(val sel: SelectionView, val context:Context) : MenuEvent()
    data class CreateSelection(val date: LocalDate, val isForWeek: Boolean, val context:Context) : MenuEvent()
